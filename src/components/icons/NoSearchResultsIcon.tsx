        ...
        <svg class={props.class} viewBox="0 -0.5 17 17">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(2.000000, 0.000000)" fill="currentColor">
                    ...
                    <path
                        d="M8.575,11.832 L9.589,10.819 C8.658,10.978 7.592,11.08 6.463,11.08 C2.947,11.08 0.0160000001,10.1 0.0160000001,9.444 L0.0160000001,12.713 C0.0160000001,13.901 2.903,14.859 6.463,14.859 C7.391,14.859 8.272,14.793 9.068,14.675 L10.244,13.499 L8.575,11.832 L8.575,11.832 Z"
                    />
                    <path
